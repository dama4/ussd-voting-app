...
const db = mysql.createConnection({
    host: 'bh3kgjwjasdnz6igh2j2-mysql.services.clever-cloud.com',
    user: 'uztznkvvz1ayutik',
    password: 'K9ZxS5KwbeIh8EvauEyf', // Replace with your MySQL password
    database: 'bh3kgjwjasdnz6igh2j2'
});
